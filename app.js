...
const defaultProducts = [
  {
    ...
    name: 'Hommikuvalgus',
    description: 'Soe ja pehme maal, mis toob tuppa päikese.',
    price: 145,
    stock: 4,
    category: 'Maal',
  },
  {
    id: crypto.randomUUID(),
    name: 'Meresõnum',
    description: 'Print, mis meenutab vaikset randa ja lõõgastust.',
    price: 68,
    stock: 8,
    category: 'Print',
  },
  {
    id: crypto.randomUUID(),
    name: 'Kodu süda',
    description: 'Käsitööna valminud väike kunstieseme tükk.',
    price: 92,
    stock: 3,
    category: 'Kunstieseme',
  },
];
